import random, sys, pygame_widgets, pygame as pg
...
class J:
    ...
    def attack(self, bouton_quit, bouton_1, bouton_2, bouton_3, adv, lst_joueur):
        (
            bouton_1.settexte("Physique"),
            bouton_2.settexte("Renforcée"),
            bouton_3.settexte("Magique"),
        )
        self.boite_info()
        running = True
        selecAtta = False
        ...
        while running:
            ...
            if selecMA:
                ...
                if 100 - (35 - self.prec) < cp_crit <= 100:
                    if mana_uti != 0:
                        self.affiche_texte(
                            "Votre avez raté votre attaque", lst_joueur, 2.5, adv
                        )
                        ...
                        self.affiche_texte(
                            "Votre défense à raté votre attaque", lst_joueur, 2.5, adv
                        )
                        pg.draw.rect(
                            screen,
                            (0, 0, 0),
                    ...
                    if atta_type == "Physique":
                        ...
                        self.affiche_texte(
                            "Vous infligez "
                            + str(degats)
                            + " de dégats physique sur un coup critique",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                    ...
                    if atta_type == "Physique":
                        degats = self.force * 5
                        self.affiche_texte(
                            "Vous infligez " + str(degats) + " de dégats physique",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "Vous infligez "
                            + str(degats)
                            + " de dégats avec votre attaque magique",
                            lst_joueur,
                            2.5,
                            adv,
                        )
        ...
        while running:
            ...
            if selecMD:
                ...
                if 100 - (35 - self.prec) < def_crit <= 100:
                    if int(mana_uti) != 0:
                        self.affiche_texte(
                            "Votre défense à raté et vous prenez l'attaque de plein fouet",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                    ...
                    if def_type == "Physique":
                        degats_def = self.defence * 2.5
                        self.affiche_texte(
                            "Vous défendez " + str(degats_def) + " de dégats physique",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "Vous défendez "
                            + str(degats_def)
                            + " de dégats avec votre défense magique",
                            lst_joueur,
                            2.5,
                            adv,
                        )
    ...
    def selec_atta(self, atta_type, selecAtta, bouton_1, bouton_2, bouton_3):
        ...
        if not selecAtta:
            if atta_type == "":
                screen.blit(
                    atkfont.render(
                        "Veuillez séléctionner votre attaque ? ", True, (255, 255, 255)
                    ),
                ...
                screen.blit(
                    atkfont.render(
                        "Vous allez utiliser une attaque " + str(atta_type),
                        True,
                        (255, 255, 255),
                    ),
                    (int(screen.get_width() / 5), 15),
    ...
    def selec_def(self, def_type, selecDef, bouton_1, bouton_2, bouton_3):
        ...
        if not selecDef:
            if def_type == "":
                screen.blit(
                    atkfont.render(
                        "Veuillez séléctionner votre défense ? ", True, (255, 255, 255)
                    ),
                    (int(screen.get_width() / 5), 15),
                )
            else:
                screen.blit(
                    atkfont.render(
                        "Vous allez utiliser une défense " + str(def_type),
                        True,
                        (255, 255, 255),
                    ),
                    (int(screen.get_width() / 5), 15),
    ...
    def mana_atta(self, mana_uti, selecMD):
        if not selecMD:
            ...
            screen.blit(
                atkfont.render(
                    "Vous allez utiliser " + str(mana_uti) + " points de mana",
                    True,
                    (255, 255, 255),
                ),
                (int(screen.get_width() / 5), 15),
    ...
    def boite_info(self):
        ...
        screen.blit(
            vsmallfont.render(str(self.pv) + " PV", 1, (255, 255, 255)),
            [
                pos_0 - retirer,
        ...
        screen.blit(
            vsmallfont.render("Force :", 1, (255, 255, 255)),
            [25, 75 + (120 * (self.id - 1) + 20 * (self.id - 1)), 50, 25],
        )
        screen.blit(
            vsmallfont.render("Défense :", 1, (255, 255, 255)),
        ...
        screen.blit(
            vsmallfont.render("Précision :", 1, (255, 255, 255)),
...
class Banshee:
    ...
    def __init__(self, liste_joueur):
        ...
        self.prec = 10
        self.turn = True
        self.BarreDeVie = BarreDeVie(300, "Banshee", self.pv, self.pvbase)
    ...
    def boite_info(self):
        ...
        screen.blit(
            vsmallfont.render("Force :", 1, (255, 255, 255)), [pos_1 - 220, 75, 50, 25]
        )
        screen.blit(
            vsmallfont.render("Défense :", 1, (255, 255, 255)),
            [pos_1 - 118, 75, 50, 25],
...
class Night_walker:
    ...
    def attack(self, target, liste_joueur):
        ...
        pg.draw.rect(screen, (0, 0, 0), [0, 0, screen.get_width(), screen.get_height()])
        self.affiche_texte(
            "Le marcheur de la nuit prépare son attaque", liste_joueur, 3
        )
        pg.draw.rect(screen, (0, 0, 0), [0, 0, screen.get_width(), screen.get_height()])

        if 100 - (35 - self.prec) < crit <= 100:
            self.affiche_texte(
                "Le marcheur de la nuit rate son attaque", liste_joueur, 4
            )
    ...
    def defences(self, degats, liste_joueur):
        ...
        if self.ombre >= 1:
            self.affiche_texte(
                "Le marcheur de la nuit se déplace trop vite dans l'obscuritée et parvient à éviter vos attaques",
                liste_joueur,
                3,
            )
            self.ombre -= 1
            ...
            self.affiche_texte(
                "Le marcheur de la nuit rate sa défense", liste_joueur, 3
            )
            ...
            if 95 < deftype <= 100:
                self.affiche_texte(
                    "Le marcheur de la nuit transorme l'entièreté de son corps en ombre évite tout les dégâts",
                    liste_joueur,
                    3,
                )
                self.ombre += len(liste_joueur)
    ...
    def boite_info(self):
        ...
        if self.pv < self.pvbase / 4:
            ...
            screen.blit(
                vsmallfont.render("?" + " PV", 1, (255, 255, 255)),
                [pos_0 - 79 - retirer, 30, retirer, 25],
            )
        screen.blit(
            vsmallfont.render("Stats :", 1, (255, 255, 255)), [pos_1 - 220, 55, 50, 25]
        ...
        screen.blit(
            vsmallfont.render("Ombre :", 1, (255, 255, 255)), [pos_1 - 220, 115, 50, 25]
        )
        retirer = vsmallfont.render(str(self.force), 1, (255, 255, 255)).get_rect()[2]
        screen.blit(
            vsmallfont.render(str(self.force), 1, (255, 255, 255)),
    ...
    while game_over == 0:
        ...
        for joueur in liste_joueur:
            ...
            if len(liste_joueur) == 0:
                ...
                screen.blit(
                    atkfont.render("Fin de la partie", 1, (255, 255, 255)),
            ...
            if banshee.getpv() <= 0:
                ...
                if len(liste_joueur) < nb_joueur:
                    screen.blit(
                        atkfont.render(
                            "Vous avez gagnez au prix de la vie de vos camarades",
                            1,
                            (255, 255, 255),
                        ),
                        [int(screen.get_width() / 5), 100],
                    ...
                    screen.blit(
                        atkfont.render(
                            "Félicitations, vous avez vaincu la banshee",
                            1,
                            (255, 255, 255),
                        ),
                        [int(screen.get_width() / 5), 100],
    ...
    while game_over == 0:
        ...
        for joueur in liste_joueur:
            ...
            if len(liste_joueur) == 0:
                ...
                screen.blit(
                    atkfont.render(
                        "Les ténèbres ont engloutie tous les joueurs",
                        1,
                        (255, 255, 255),
                    ),
                    [int(screen.get_width() / 5), 100],
            ...
            if NW.getpv() <= 0:
                if len(liste_joueur) < nb_joueur:
                    ...
                    screen.blit(
                        atkfont.render(
                            "Félicitations, vous avez vaincu le marcheur de la nuit",
                            1,
                            (255, 255, 255),
                        ),
                        [int(screen.get_width() / 5), 100],
...
def nbperso(perso, selecPerso, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecPerso:
        if perso == 0:
            ...
            screen.blit(
                atkfont.render(
                    "Vous avez choisi de jouer à : " + str(perso), True, (255, 255, 255)
                ),
                (15, 15),
            )
            selecPerso = True
...
def nom(nom, selecNOM):
    if not selecNOM:
        screen.blit(
            atkfont.render(
                "Quel est votre nom, aventurier ? " + str(nom), True, (255, 255, 255)
            ),
            (15, 15),
        )
    else:
        screen.blit(
            atkfont.render("Votre nom est : " + str(nom), True, (255, 255, 255)),
            (15, 15),
        )
        selecNOM = True
        return selecNOM
...
def nbpv(pv, selecPV, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecPV:
        if pv == 0:
            screen.blit(
                atkfont.render(
                    "Combien de points de vie avez vous ? ", True, (255, 255, 255)
                ),
                (15, 15),
            )
        else:
            screen.blit(
                atkfont.render("Vous avez " + str(pv) + " PV", True, (255, 255, 255)),
                (15, 15),
            )
            selecPV = True
            return selecPV
...
def nbmana(mana, selecMana, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecMana:
        if mana == 0:
            ...
            screen.blit(
                atkfont.render(
                    "Vous avez " + str(mana) + " mana", True, (255, 255, 255)
                ),
                (15, 15),
            )
            selecMana = True
...
def nbstats(stats, force, Def, prec, selecStats, bouton_1, sliders):
    ...
    if not selecStats:
        if stats == 0:
            screen.blit(
                atkfont.render(
                    "Quelles sont vos statistiques ? (Force / Défense / Précision)",
                    True,
                    (255, 255, 255),
                ),
                (15, 15),
            ...
            screen.blit(
                atkfont.render(
                    "Vous avez " + str(force) + " points de force",
                    True,
                    (255, 255, 255),
                ),
                (15, 15),
            ...
            screen.blit(
                atkfont.render(
                    "Vous avez " + str(Def) + " points de défense",
                    True,
                    (255, 255, 255),
                ),
                (15, 45),
            ...
            screen.blit(
                atkfont.render(
                    "Vous avez " + str(prec) + " % de précision", True, (255, 255, 255)
                ),
                (15, 75),
            )
            selecStats = True
...
def JouerBoucle():
    ...
    while running:
        ...
        text = smallfont.render(
            "Voullez-vous lancer une nouvelle partie ?", True, (255, 255, 255)
        )
