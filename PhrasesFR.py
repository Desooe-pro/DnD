phrasesClass = {
  "banshee": {
    ...
    "attack": {
      ...
      "defense": {
        "fail": ["Vous avez frappé dans la faille du bouclier de la banshee, elle subit donc les dégats de plein fouet équivalent à ", " dégâts"],
        "succes": ["La banshee diminue les dégats reçus de 50 points avec son bouclier magique et subit ", " dégâts"],
      },
      "infoBox": { 
        "pv": " PV", 
        "stats": "Stats :", 
