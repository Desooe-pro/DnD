...
class J:
    ...
    def attack(self, bouton_quit, bouton_1, bouton_2, bouton_3, adv, lst_joueur):
        (
            bouton_1.settexte("Physical"),
            bouton_2.settexte("Reinforced"),
            bouton_3.settexte("Magic"),
        )
        self.boite_info()
        running = True
        selecAtta = False
        ...
        while running:
            ...
            for ev in pg.event.get():
                ...
                if ev.type == pg.MOUSEBUTTONDOWN:
                    ...
                    if (
                        bouton_quit.getwidth()[0]
                        <= mouse[0]
                        <= bouton_quit.getwidth()[1]
                        and bouton_quit.getheight()[0]
                        <= mouse[1]
                        <= bouton_quit.getheight()[1]
                        and not bouton_quit.getstate() in ["Down", "Dead"]
                    ):
                        pg.quit()
                        sys.exit()
                    elif (
                        bouton_1.getwidth()[0] <= mouse[0] <= bouton_1.getwidth()[1]
                        and bouton_1.getheight()[0]
                        <= mouse[1]
                        <= bouton_1.getheight()[1]
                    ):
                        if not selecAtta:
                            atta_type = "Physical"
                            selecMA = True
                    elif (
                        bouton_2.getwidth()[0] <= mouse[0] <= bouton_2.getwidth()[1]
                        and bouton_2.getheight()[0]
                        <= mouse[1]
                        <= bouton_2.getheight()[1]
                    ):
                        if not selecAtta:
                            atta_type = "Reinforced"
                    elif (
                        bouton_3.getwidth()[0] <= mouse[0] <= bouton_3.getwidth()[1]
                        and bouton_3.getheight()[0]
                        <= mouse[1]
                        <= bouton_3.getheight()[1]
                    ):
                        if not selecAtta:
                            atta_type = "Magic"
            ...
            if selecMA:
                ...
                if 100 - (35 - self.prec) < cp_crit <= 100:
                    if mana_uti != 0:
                        self.affiche_texte(
                            "Your defence has failed", lst_joueur, 2.5, adv
                        )
                        self.mana -= mana_uti
                        pg.draw.rect(
                            screen,
                    ...
                    if atta_type == "Physical":
                        ...
                        self.affiche_texte(
                            "You inflict "
                            + str(degats)
                            + " physical damages on a critical hit",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You inflict "
                            + str(degats)
                            + " physical damages on a critical hit thanks to your mana reinforced attack",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You inflict "
                            + str(degats)
                            + " magic damages on a critical hit",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                    ...
                    if atta_type == "Physical":
                        degats = self.force * 5
                        self.affiche_texte(
                            "You inflict " + str(degats) + " physical damages",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You inflict "
                            + str(degats)
                            + " physical damages thanks to your mana reinforced attack",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You inflict "
                            + str(degats)
                            + " damages with your magic attack",
                            lst_joueur,
                            2.5,
                            adv,
                        )
        ...
        while running:
            ...
            if selecMD:
                ...
                if 100 - (35 - self.prec) < def_crit <= 100:
                    if int(mana_uti) != 0:
                        self.affiche_texte(
                            "Your defence failed and you endured the attack head-on",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                    ...
                    if def_type == "Physical":
                        ...
                        self.affiche_texte(
                            "You parry "
                            + str(degats_def)
                            + " physical damages on a perfect defence",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You parry "
                            + str(degats_def)
                            + " damages with one of the most magificent enchanted defence",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You parry "
                            + str(degats_def)
                            + " damages with a magical defence worthy of the world's greatest mages",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                    ...
                    if def_type == "Physical":
                        degats_def = self.defence * 2.5
                        self.affiche_texte(
                            "You parry " + str(degats_def) + " physical damages",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You parry "
                            + str(degats_def)
                            + " damages with an enchanted defence",
                            lst_joueur,
                            2.5,
                            adv,
                        )
                        ...
                        self.affiche_texte(
                            "You parry "
                            + str(degats_def)
                            + " damages with a magical defence",
                            lst_joueur,
                            2.5,
                            adv,
                        )
    ...
    def selec_atta(self, atta_type, selecAtta, bouton_1, bouton_2, bouton_3):
        ...
        if not selecAtta:
            if atta_type == "":
                screen.blit(
                    atkfont.render(
                        "Which attack will you choose ?", True, (255, 255, 255)
                    ),
                ...
                screen.blit(
                    atkfont.render(
                        "You use an attack of the " + str(atta_type) + " type",
                        True,
                        (255, 255, 255),
                    ),
                    (int(screen.get_width() / 5), 15),
    ...
    def selec_def(self, def_type, selecDef, bouton_1, bouton_2, bouton_3):
        ...
        if not selecDef:
            if def_type == "":
                screen.blit(
                    atkfont.render(
                        "Which defence will you choose ?", True, (255, 255, 255)
                    ),
                    (int(screen.get_width() / 5), 15),
                )
            else:
                screen.blit(
                    atkfont.render(
                        "You use a defence of the " + str(def_type) + " type",
                        True,
                        (255, 255, 255),
                    ),
                    (int(screen.get_width() / 5), 15),
    ...
    def mana_atta(self, mana_uti, selecMD):
        if not selecMD:
            screen.blit(
                atkfont.render(
                    "Howmuch mana will you use ? " + str(mana_uti),
                    True,
                    (255, 255, 255),
                ),
                (int(screen.get_width() / 5), 15),
            ...
            screen.blit(
                atkfont.render(
                    "You're going to consume " + str(mana_uti) + " mana points",
                    True,
                    (255, 255, 255),
                ),
                (int(screen.get_width() / 5), 15),
    ...
    def boite_info(self):
        if self.turn == True:
            pg.draw.rect(
                screen,
                (0, 255, 0),
                [13, 13 + (120 * (self.id - 1) + 20 * (self.id - 1)), 219, 119],
            )
        pg.draw.rect(
            screen,
            (255, 255, 255),
            [15, 15 + (120 * (self.id - 1) + 20 * (self.id - 1)), 215, 115],
        )
        pg.draw.rect(
            screen,
            (200, 200, 200),
            [18, 18 + (120 * (self.id - 1) + 20 * (self.id - 1)), 209, 109],
        )
        pg.draw.rect(
            screen,
            (170, 170, 170),
            [18, 21 + (120 * (self.id - 1) + 20 * (self.id - 1)), 206, 106],
        )
        pg.draw.rect(
            screen,
            (130, 130, 130),
            [21, 21 + (120 * (self.id - 1) + 20 * (self.id - 1)), 203, 103],
        )
        pg.draw.rect(
            screen,
            (50, 50, 50),
        ...
        screen.blit(
            vsmallfont.render(str(self.pv) + " HP", 1, (255, 255, 255)),
            [
                pos_0 - retirer,
        ...
        screen.blit(
            vsmallfont.render("Stats :", 1, (255, 255, 255)),
            [25, 55 + (120 * (self.id - 1) + 20 * (self.id - 1)), 50, 25],
        )
        screen.blit(
            vsmallfont.render("Strength :", 1, (255, 255, 255)),
            [25, 75 + (120 * (self.id - 1) + 20 * (self.id - 1)), 50, 25],
        )
        screen.blit(
            vsmallfont.render("Defence :", 1, (255, 255, 255)),
            [127, 75 + (120 * (self.id - 1) + 20 * (self.id - 1)), 50, 25],
        )
        screen.blit(
            vsmallfont.render("Mana :", 1, (255, 255, 255)),
            [25, 95 + (120 * (self.id - 1) + 20 * (self.id - 1)), 50, 25],
        )
        screen.blit(
            vsmallfont.render("Accuracy :", 1, (255, 255, 255)),
    ...
    def info_attaque(self):
        msg = smallfont.render(
            "A physical attack doesn't consume mana, an enchanted one consumes from 1 to 50 mana points and a magic one between 51 and 500 mana points (:",
            1,
            (255, 255, 255),
        )
    ...
    def info_defence(self):
        msg = smallfont.render(
            "A physical defence doesn't consume mana, a reinforced one consumes from 1 to 50 mana points and a magic one between 51 and 500 mana points (:",
            1,
            (255, 255, 255),
        )
        text_rect = msg.get_rect(
...
class Banshee:
    ...
    def attack(self, joueur_att, liste_joueur):
        ...
        if 0 < att_banshee <= 60:
            ...
            self.affiche_texte(
                ...
                + " consuming a small amout of mana to inflict "
                + str(degats)
                + " damages",
                liste_joueur,
                4,
        ...
        if 60 < att_banshee <= 95:
            ...
            self.affiche_texte(
                "The Banshee attacks "
                + str(joueur_att.getnom())
                + " consuming a great amout of mana to inflict "
                + str(degats)
                + " damages",
                liste_joueur,
                4,
        ...
        if 95 < att_banshee <= 100 and self.pv <= 1500:
            degats = self.pv
            self.affiche_texte(
                "The Banshee sacrifices what's left of her health to inflict "
                + str(degats)
                + " damages to all players",
                liste_joueur,
                4,
            )
            self.pv = 0
        ...
        if 95 < att_banshee <= 100:
            degats = 750
            self.affiche_texte(
                "The Banshee tries to use her most powerful attack by sacrificing what's left of her health but wasn't weakened enough to use it, instead she inflicts "
                + str(degats)
                + " damages to all players",
                liste_joueur,
                4,
    ...
    def defences(self, degats, liste_joueur):
        ...
        if 100 - (35 - self.prec) < def_crit <= 100:
            self.affiche_texte(
                "Your attack went through a breach in the Banshee's shield and so she endures it head-on and takes "
                + str(degats + 50)
                + " damages",
                liste_joueur,
                4,
            ...
            self.affiche_texte(
                "The Banshee's shield reduces the damages she takes to "
                + str(degats - 50),
                liste_joueur,
                4,
            )
    ...
    def boite_info(self):
        ...
        screen.blit(
            vsmallfont.render("Stats :", 1, (255, 255, 255)), [pos_1 - 220, 55, 50, 25]
        )
        screen.blit(
            vsmallfont.render("Strength :", 1, (255, 255, 255)),
            [pos_1 - 220, 75, 50, 25],
        ...
        screen.blit(
            vsmallfont.render("Mana :", 1, (255, 255, 255)), [pos_1 - 220, 95, 50, 25]
        )
        screen.blit(
            vsmallfont.render("Accuracy :", 1, (255, 255, 255)),
            [pos_1 - 118, 95, 50, 25],
...
class Night_walker:
    ...
    def attack(self, target, liste_joueur):
        ...
        if 100 - (35 - self.prec) < crit <= 100:
            ...
            if 0 < attatype <= 60:
                ...
                self.affiche_texte(
                    "The Night Walker attacks "
                    + str(target.getnom())
                    + " quickly and inflicts "
                    + str(degats)
                    + " damages on a critical hit",
                    liste_joueur,
                    4,
                )
                return degats
                ...
                self.affiche_texte(
                    "The Night Walker attacks "
                    + str(target.getnom())
                    + " using a heavy object found somewhere around the place with surprising strength and inflicts "
                    + str(degats)
                    + " damages",
                    liste_joueur,
                    4,
                ...
                self.affiche_texte(
                    ...
                    + " quickly and inflicts "
                    + str(degats)
                    + " damages on a critical hit before disappearing in the shadows",
                    liste_joueur,
                    4,
                )
                return degats
            ...
            if 0 < attatype <= 60:
                ...
                self.affiche_texte(
                    "The Night Walker attacks "
                    + str(target.getnom())
                    + " using a heavy object found somewhere around the place and inflicts "
                    + str(degats)
                    + " damages",
                    liste_joueur,
                    4,
                ...
                self.affiche_texte(
                    ...
                    + " quickly and inflicts "
                    + str(degats)
                    + " damages before disappearing in the shadows",
                    liste_joueur,
                    4,
                )
                return degats
    ...
    def defences(self, degats, liste_joueur):
        ...
        if self.ombre >= 1:
            self.affiche_texte(
                "The Night Walker moves too fast in the shadows for you to land a hit",
                liste_joueur,
                4,
            )
            self.ombre -= 1
            ...
            if 0 < deftype <= 60:
                ...
                self.affiche_texte(
                    "The Night Walker manages to prepare his best defence and parries "
                    + str(degats_def)
                    + " damages",
                    liste_joueur,
                    4,
            ...
            if 60 < deftype <= 95:
                ...
                self.affiche_texte(
                    "The Night Walker surprisingly quickly changes some parts of his body into shadows using a small amount of mana and parries "
                    + str(degats_def)
                    + " damages",
                    liste_joueur,
                    4,
            ...
            if 95 < deftype <= 100:
                self.affiche_texte(
                    "The Night Walker morphs into shadows and dodge every damages",
                    liste_joueur,
                    4,
                )
                self.ombre += len(liste_joueur)
            ...
            if 0 < deftype <= 60:
                ...
                self.affiche_texte(
                    "The Night Walker manages to parry " + str(degats_def) + " damages",
                    liste_joueur,
                    4,
                )
                self.pv -= degats - degats_def
            ...
            if 60 < deftype <= 95:
                ...
                self.affiche_texte(
                    "The Night Walker changes some parts of his body into shadows using a small amount of mana and parries "
                    + str(degats_def)
                    + " damages",
                    liste_joueur,
                    4,
            ...
            if 95 < deftype <= 100:
                ...
                self.affiche_texte(
                    "The Night Walker changes most of his body into shadows using a great amount of mana and parries"
                    + str(degats_def)
                    + " damages",
                    liste_joueur,
                    4,
    ...
    def boite_info(self):
        ...
        if self.pv < self.pvbase / 4:
            ...
            screen.blit(
                vsmallfont.render("?" + " HP", 1, (255, 255, 255)),
                [pos_0 - 79 - retirer, 30, retirer, 25],
            )
        screen.blit(
            vsmallfont.render("Stats :", 1, (255, 255, 255)), [pos_1 - 220, 55, 50, 25]
        ...
        screen.blit(
            vsmallfont.render("Shadow :", 1, (255, 255, 255)),
            [pos_1 - 220, 115, 50, 25],
        )
        retirer = vsmallfont.render(str(self.force), 1, (255, 255, 255)).get_rect()[2]
        screen.blit(
...
class Bouton:
    def __init__(
        self, widthtop, widthbot, heighttop, heightbot, texte, font, color, state
    ):
    ...
    def affiche_bouton(self):
        center_rect = pg.draw.rect(
            screen,
            (179, 179, 179),
            [self.widthtop + 5, self.heighttop + 5, self.width - 5, self.height - 5],
        )
        ...
        if self.state == "Down":
            pg.draw.rect(
                screen,
                (17, 17, 17),
                [self.widthtop, self.heighttop, self.width + 5, self.height + 5],
            )
            for loop in range(5):
                pg.draw.rect(
                    screen,
                    (131, 131, 131),
                    [self.widthtop, self.heighttop + loop, self.width + 5 - loop, 1],
                )
            for loop in range(5):
                pg.draw.rect(
                    screen,
                    (131, 131, 131),
                    [self.widthtop + loop, self.heighttop, 1, self.height + 5 - loop],
                )
            ...
            self.widthtop <= mouse[0] <= self.widthbot
            and self.heighttop <= mouse[1] <= self.heightbot
...
class Histoire:
    ...
    def affiche_histoire(self):
        ...
        while game_over:
            ...
            self.bouton_quit.setheight(
                screen.get_height() - 55, screen.get_height() - 15
            )
            ...
            for ev in pg.event.get():
                ...
                if ev.type == pg.MOUSEBUTTONDOWN:
                    mouse = pg.mouse.get_pos()
                    if (
                        self.bouton_quit.getwidth()[0]
                        <= mouse[0]
                        <= self.bouton_quit.getwidth()[1]
                        and self.bouton_quit.getheight()[0]
                        <= mouse[1]
                        <= self.bouton_quit.getheight()[1]
                        and not self.bouton_quit.getstate() in ["Down", "Dead"]
                    ):
                        pg.quit()
                        game_over = False
                        sys.exit()
    ...
    while game_over == 0:
        ...
        for joueur in liste_joueur:
            ...
            if len(liste_joueur) == 0:
                ...
                screen.blit(
                    atkfont.render(
                        "The banshee's screams shredded all the adventurers to pieces",
                        1,
                        (255, 255, 255),
                    ),
                    [int(screen.get_width() / 5), 100],
                ...
                screen.blit(
                    atkfont.render("Game Over", 1, (255, 255, 255)),
            ...
            if banshee.getpv() <= 0:
                ...
                if len(liste_joueur) < nb_joueur:
                    screen.blit(
                        atkfont.render(
                            "You have won at the cost of your comrades' lives",
                            1,
                            (255, 255, 255),
                        ),
                        [int(screen.get_width() / 5), 100],
                    ...
                    screen.blit(
                        atkfont.render(
                            "Congratulations, you have defeated the banshee",
                            1,
                            (255, 255, 255),
                        ),
                        [int(screen.get_width() / 5), 100],
    ...
    while game_over == 0:
        ...
        for joueur in liste_joueur:
            ...
            if len(liste_joueur) == 0:
                ...
                screen.blit(
                    atkfont.render(
                        "The darkness has engulfed all the players", 1, (255, 255, 255)
                    ),
                    [int(screen.get_width() / 5), 100],
                )
                screen.blit(
...
def nbperso(perso, selecPerso, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecPerso:
        if perso == 0:
            screen.blit(
                atkfont.render(
                    "How many player do you want to create ? (4 max)",
                    True,
                    (255, 255, 255),
                ),
                (15, 15),
            ...
            screen.blit(
                atkfont.render(
                    "You have chosen to play with : " + str(perso),
                    True,
                    (255, 255, 255),
                ),
                (15, 15),
...
def nom(nom, selecNOM):
    if not selecNOM:
        screen.blit(
            atkfont.render(
                "What's your name, adventurer ? " + str(nom), True, (255, 255, 255)
            ),
            (15, 15),
        )
    else:
        screen.blit(
            atkfont.render("Your name is : " + str(nom), True, (255, 255, 255)),
            (15, 15),
        )
        selecNOM = True
        return selecNOM
...
def nbpv(pv, selecPV, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecPV:
        if pv == 0:
            screen.blit(
                atkfont.render(
                    "How many health points do you have ? ", True, (255, 255, 255)
                ),
                (15, 15),
            )
        else:
            screen.blit(
                atkfont.render("You have " + str(pv) + " HP", True, (255, 255, 255)),
                (15, 15),
            )
            selecPV = True
            return selecPV
...
def nbmana(mana, selecMana, bouton_1, bouton_2, bouton_3, bouton_4):
    ...
    if not selecMana:
        if mana == 0:
            screen.blit(
                atkfont.render(
                    "What is the size of your mana pool ?", True, (255, 255, 255)
                ),
                (15, 15),
            )
        else:
            screen.blit(
                atkfont.render(
                    "You have " + str(mana) + " mana", True, (255, 255, 255)
                ),
                (15, 15),
            )
            selecMana = True
...
def nbstats(
    stats, force, Def, prec, selecStats, bouton_1, bouton_2, bouton_3, bouton_4
):
    (
        bouton_1.affiche_bouton(),
        bouton_2.affiche_bouton(),
    ...
    if not selecStats:
        if stats == 0:
            screen.blit(
                atkfont.render(
                    "What are your stats? (Strength / Defense / Accuracy)",
                    True,
                    (255, 255, 255),
                ),
                (15, 15),
            ...
            screen.blit(
                atkfont.render(
                    "You have " + str(force) + " strength", True, (255, 255, 255)
                ),
                (15, 15),
            )
            screen.blit(
                atkfont.render(
                    "You have " + str(Def) + " defence", True, (255, 255, 255)
                ),
                (15, 45),
            )
            screen.blit(
                atkfont.render(
                    "You have " + str(prec) + " % accuracy", True, (255, 255, 255)
                ),
                (15, 75),
            )
            selecStats = True
    ...
    while game_over == 0:
        ...
        for ev in pg.event.get():
            ...
            if ev.type == pg.MOUSEBUTTONDOWN:
                mouse = pg.mouse.get_pos()
                if (
                    bouton_quit.getwidth()[0] <= mouse[0] <= bouton_quit.getwidth()[1]
                    and bouton_quit.getheight()[0]
                    <= mouse[1]
                    <= bouton_quit.getheight()[1]
                    and not bouton_quit.getstate() in ["Down", "Dead"]
                    ...
                    bouton_1.getwidth()[0] <= mouse[0] <= bouton_1.getwidth()[1]
                    and bouton_1.getheight()[0] <= mouse[1] <= bouton_1.getheight()[1]
                ):
                    if not selecPerso:
                        perso = 1
                    ...
                    bouton_2.getwidth()[0] <= mouse[0] <= bouton_2.getwidth()[1]
                    and bouton_2.getheight()[0] <= mouse[1] <= bouton_2.getheight()[1]
                ):
                    if not selecPerso:
                        perso = 2
                    ...
                    bouton_3.getwidth()[0] <= mouse[0] <= bouton_3.getwidth()[1]
                    and bouton_3.getheight()[0] <= mouse[1] <= bouton_3.getheight()[1]
                ):
                    if not selecPerso:
                        perso = 3
                    ...
                    bouton_4.getwidth()[0] <= mouse[0] <= bouton_4.getwidth()[1]
                    and bouton_4.getheight()[0] <= mouse[1] <= bouton_4.getheight()[1]
                ):
                    if not selecPerso:
                        perso = 4
        ...
        if not selecPerso:
            ...
            if perso > 0:
                ...
                if (not selecMana) and selecPV:
                    ...
                    if selecMana:
                        (
                            bouton_1.settexte("25/50/25"),
                            bouton_2.settexte("30/45/25"),
                            bouton_3.settexte("40/40/20"),
                            bouton_4.settexte("50/40/10"),
                        )
                        (
                            bouton_1.setstate(""),
                            bouton_2.setstate(""),
                ...
                if selecStat and loop == 0:
                    ...
                    if perso == 0:
                        while stop == 0:
                            bouton_quit.setheight(
                                screen.get_height() - 55, screen.get_height() - 15
                            )
                            bouton_quit.setwidth(
                                screen.get_width() - 155, screen.get_width() - 15
                            )
                            bouton_compris.setheight(
                                screen.get_height() - 110, screen.get_height() - 70
                            )
                            bouton_compris.setwidth(
                                screen.get_width() - 155, screen.get_width() - 15
                            )
                            for ev in pg.event.get():
                                if ev.type == pg.QUIT:
                                ...
                                if ev.type == pg.MOUSEBUTTONDOWN:
                                    ...
                                    if (
                                        ...
                                        bouton_compris.getwidth()[0]
                                        <= mouse[0]
                                        <= bouton_compris.getwidth()[1]
                                        and bouton_compris.getheight()[0]
                                        <= mouse[1]
                                        <= bouton_compris.getheight()[1]
                                        and not bouton_compris.getstate()
                                        in ["Down", "Dead"]
                                    ):
                                        stop = 1
                            pg.draw.rect(
                ...
                if adversaire_selec == 1:
                    if hist == 1:
                        ...
                        histo = Histoire(
                            [
                                "You enter a dark room, darker than the blackest night of your life",
                ...
                if adversaire_selec == 2:
                    if hist == 1:
                        ...
                        histo = Histoire(
                            [
                                "You arrive in a clearing illuminated by the moonlight and rejoice at finally being in a peaceful place",
                                ...
                                "You find yourself face to face with a banshee",
                            ],
                            atkfont,
                        )
                        histo.affiche_histoire()
    ...
    while running:
        ...
        for ev in pg.event.get():
            ...
            if ev.type == pg.MOUSEBUTTONDOWN:
                mouse = pg.mouse.get_pos()
                if (
                    bouton_non.getwidth()[0] <= mouse[0] <= bouton_non.getwidth()[1]
                    and bouton_non.getheight()[0]
                    <= mouse[1]
                    <= bouton_non.getheight()[1]
                ):
                    pg.quit()
                    running = False
                    sys.exit()
                    ...
                    bouton_oui.getwidth()[0] <= mouse[0] <= bouton_oui.getwidth()[1]
                    and bouton_oui.getheight()[0]
                    <= mouse[1]
                    <= bouton_oui.getheight()[1]
                ):
                    replay = True
                    running = False
...
bouton_quit = Bouton(
    screen.get_width() / 2 - 100,
    screen.get_width() / 2 + 100,
    screen.get_height() - 165,
    screen.get_height() - 115,
    "Quit",
    font,
    (255, 255, 255),
    "",
...
while running:
    ...
    for ev in pg.event.get():
        ...
        if ev.type == pg.MOUSEBUTTONDOWN:
            ...
            if (
                bouton_quit.getwidth()[0] <= mouse[0] <= bouton_quit.getwidth()[1]
                and bouton_quit.getheight()[0] <= mouse[1] <= bouton_quit.getheight()[1]
                and not bouton_quit.getstate() in ["Down", "Dead"]
            ):
                pg.quit()
                running = False
                ...
                bouton_Jouer.getwidth()[0] <= mouse[0] <= bouton_Jouer.getwidth()[1]
                and bouton_Jouer.getheight()[0]
                <= mouse[1]
                <= bouton_Jouer.getheight()[1]
            ):
                Jouer()
                ask = True
